...
export const fmSongs: FmSong[] = [
  ...
  },
  {
    ...
    album: `The Life of a Showgirl`,
    review: {
      en: `The age gap is a hallway you walk down every day, pretending not to count the doors. At the office party he calls you ma'am in front of everyone, then honey when the elevator doors close. You shouldn't want either word. You want both. Later he falls asleep on your shoulder on the ride home, mouth slightly open, completely unafraid. You stare at your reflection in the dark window and think: this is the sweetest thing that will ever ruin me.`,
  ...
  },
  {
    ...
    album: `Lover`,
    review: {
      en: `You take a different train now. The old stop is two blocks from his building and two blocks is two blocks too many. Sometimes you still get off by mistake, muscle memory stronger than pride. You stand on the corner and watch the window. The light is on. The light is off. Either way you can't go up. Either way you can't leave. You become a person who haunts a street they no longer belong on.`,
  ...
  },
  {
    ...
    album: `evermore`,
    review: {
      en: `Grief moves in and pays rent on time. It sits in his chair. Drinks from his mug. Knows the password to the Netflix account you still haven't changed. Friends say you should date again. You smile and change the subject. Some nights you talk to the empty room and the room doesn't answer and that's fine, you weren't expecting it to. You're not waiting for him to come back. You're waiting for the version of you who doesn't need him to come back. That person is late.`,
  ...
  },
  {
    ...
    album: `folklore`,
    review: {
      en: `You find his sweater in the back of your closet, soft, too big, still holding the shape of someone else's body. You put it on when you're sad. Take it off when you're done being sad. Wash it. Put it back. It's not a shrine. It's a habit. Like smoking. Like checking his profile. Like pretending you're over it while keeping one thing that proves you weren't.`,
  ...
  },
  {
    ...
    album: `Starboy`,
    review: {
      en: `You feel it before it happens, the slow tilt of a room when someone walks in. He hasn't said anything yet. Neither have you. But your body knows. Your body is traitorous and hopeful and stupid. You catch yourself fixing your hair before meetings. Staying late when he stays late. You tell yourself it's nothing. Your pulse tells you something else. The storm is coming. You're not running.`,
  ...
  },
  {
    ...
    album: `行走的鱼`,
    review: {
      en: `The office is an aquarium without water. You swim through meetings. Through emails. Through small talk at the coffee machine. Your gills are dry. Everyone else seems fine. You smile. Nod. Die a little inside. By five you're exhausted from pretending to breathe. You go home. Lie on the floor. Finally, air.`,
  ...
  },
  {
    ...
    album: `鱼仔`,
    review: {
      en: `The goldfish dies while you're at work. Your roommate texts a photo, small orange body floating at the top. You stare at it in the elevator. You'd had that fish since college. Named it something stupid. Loved it in the way you love things that ask nothing of you. You get home. Flush it. Wash the bowl. Put the bowl in the cabinet. Some deaths are too small for grief. You grieve anyway.`,
  ...
  },
  {
    ...
    album: `忘记`,
    review: {
      en: `You delete the photos. Change the number. Unfollow. Block. Move. New city, new job, new haircut. You think you've forgotten. Then a song plays in a café and you're back in his kitchen, his shirt, his smell. Forgetting isn't deletion. It's compression. Everything still there. Just smaller. Harder to see. Not gone.`,
  ...
  },
  {
    ...
    album: `金玉良言`,
    review: {
      en: `Everyone has advice. Find someone stable. Find someone who shows up. Find someone who puts you first. You nod. Take notes. Go home and text the one who does none of those things. Your heart is a bad student. It never learns the lesson. It keeps choosing the same wrong answer because the wrong answer feels like home.`,
  ...
  },
  {
    ...
    album: `BITE BACK`,
    review: {
      en: `You know his coffee order. His mother's birthday. The name of his childhood dog. You forget your own deadlines. Your keys. Your worth. He says you're too much. You hear: you care too much about me. You do. That's the problem. You spent all your emotion on him. There's none left for you.`,
  ...
  },
  {
    ...
    album: `逆光`,
    review: {
      en: `You miss who you were when you loved him. Not him, her. The girl who laughed too loud. Who believed in forever. Who didn't know yet that forever is a lie people tell to make leaving hurt more. You find an old photo. That girl is gone. You mourn her sometimes. More than you mourn him.`,
  ...
  },
  {
    ...
    album: `我要的幸福`,
    review: {
      en: `It hits you in the car, watching a stranger help an old woman cross the street. Small kindness. No audience. You think: that's what I wanted. Not fireworks. Not grand gestures. Someone who'd help you cross the street and not make a thing of it. You didn't have that. Now you know what to look for. Small comfort. Late, but real.`,
  ...
  },
  {
    ...
    album: `Leave`,
    review: {
      en: `He says let's stay friends. You say sure. Hang up. Put on a show. Laugh at something that isn't funny. Make tea you don't drink. You're fine. You're fine. You're fine. Your hands shake when you pour the water. You pour it anyway. Fine is a performance. You're giving an encore.`,
  ...
  },
  {
    ...
    album: `逆光`,
    review: {
      en: `You quit on a bright day. Walk out with a box of your things, mug, plant, photo frame empty now. The sun is in your eyes. You don't look back at the building. You look forward. Can't see much. Squinting. Walking anyway. Someone holds the door. You say thanks. Keep going. The light is blinding. You choose it.`,
  ...
  },
  {
    ...
    album: `没关系`,
    review: {
      en: `"It's fine," you say when he cancels. "It's fine," when he forgets. "It's fine," when he chooses everything else first. Fine fine fine until the word means nothing. One day you stop saying it. You say nothing. He notices. Asks what's wrong. You say nothing. And mean it. Nothing is left. That's what's wrong.`,
  ...
  },
  {
    ...
    album: `残废`,
    review: {
      en: `After he leaves you can't work the thermostat. The TV. The washing machine he always fixed. You're not broken. You're just a person who let someone else hold the manual. Now you read it alone. Slow. Angry. Proud when something works. You're learning. Late. But learning.`,
  ...
  },
  {
    ...
    album: `九月底`,
    review: {
      en: `September ends. You put away the summer clothes. Pull out the sweater. Find a single sock in the back of the drawer, his, probably. You hold it. Put it back. Some seasons change. Some things don't. You make tea. Sit by the window. Watch the leaves. October comes anyway. You let it.`,
  ...
  },
  {
    ...
    review: {
      en: `You woke up early to make his coffee. Stayed up late to warm his side of the bed. Your whole orbit was him. When he left for three days you didn't know what to do with the empty hours. Ate at wrong times. Slept in the middle of the day. You were a moon without a planet. Drifting. You learned to find your own light. Slow. But yours.`,
  ...
  },
  {
    ...
    album: `One Last Kiss`,
    review: {
      en: `The airport is where goodbyes go to die. You hug him. Too long. Not long enough. He pulls away first. Goes through security. Turns once. Waves. You wave back. That's the last one. You didn't know then. You know now. You keep the boarding pass in your wallet. Proof you loved someone enough to let them go.`,
  ...
  },
  {
    ...
    album: `君に夢中`,
    review: {
      en: `You learned Japanese for him. He moved on before you finished. You kept studying anyway. Now you read menus. Watch films without subtitles. Dream in a language he never learned to love you in. The skill remains. The person doesn't. You wonder if that's a gift or a wound. Maybe both. Maybe that's life.`,
  ...
  },
  {
    ...
    album: `Me After You`,
    review: {
      en: `Before him you ate alone without thinking about it. After him you set two places out of habit. Before him you saw movies alone. After him you buy two tickets and sit in the middle, his seat empty. He changed the shape of your solitude. You're still alone. But it's a different alone. Wider. Emptier. Yours.`,
